...
VALUES ('0f751493-b9b8-4a2f-91b1-6241fce07d2c', 1, 1, 'admin@wp.pl',
        '$2a$10$PbLiLJZLq/332ZbErwPG/Ok7VWO8ve/UeWS0D3Oo/Qm5mPryLD/uO', 'admin'),
       ('3d58a2ae-a2fa-44d6-bfa0-aa258bd18e76', 1, 1, 'doctor@wp.pl',
        '$2a$10$7CHFRj6KhAZwDcwMjlS7zec5IxpnlU7jVDiEv/nbCbC39geVifCU.', 'doctor'),
       ('df1d6dfb-9ecf-4923-9557-a240c30f23ec', 1, 1, 'secretary@wp.pl',
        '$2a$10$hajUA5.9FlLdnod0ivu9l.xiCKMLzz3gkfaGuXINS0HwSFeK3aXHC', 'secretary'),
       ('c94706ea-7e26-4b1f-a8f8-d5bb4f9b3806', 1, 1, 'patient@wp.pl',
...
VALUES ('45e6da6d-c858-4ee9-a535-e5b4f50b6e54', 1, 1, '70d38aec-7631-46bc-af92-438865a1b793', 'province1', 'district1',
        'community1', 'locality1', 'street1',
        'streetNo1', 'flatNo1', '00-001', 'post1', 'name1', 'description1', 1, 1),
       ('f45ef247-e76c-45b5-85ae-163ca4e65316', 1, 1, '70d38aec-7631-46bc-af92-438865a1b793', 'province2', 'district2',
        'community2', 'locality2', 'street2',
        'streetNo2', 'flatNo2', '00-002', 'post2', 'name2', 'description2', 1, 1),
       ('c9c138b1-d73b-4528-a628-dcc52d43435d', 1, 1, '70d38aec-7631-46bc-af92-438865a1b793', 'province3', 'district3',
        'community3', 'locality3', 'street3',
        'streetNo3', 'flatNo3', '00-003', 'post3', 'name3', 'description3', 1, 1),
       ('587c048e-060c-479c-94a1-8d65ae63b369', 1, 1, '70d38aec-7631-46bc-af92-438865a1b793', 'province4', 'district4',
...
VALUES ('c41abfe7-93fb-4557-b802-4f6e5d0ace5c', 1, 1, '45e6da6d-c858-4ee9-a535-e5b4f50b6e54',
        '661f25a7-b2f3-4765-9cbd-b54eb15c1830', '+48 00 000 000 11', true),
       ('a251107c-922a-4d83-9325-5b45c89099ba', 1, 1, '45e6da6d-c858-4ee9-a535-e5b4f50b6e54',
        'd25734b0-3b40-41a5-9e94-4de4698c840a', '+48 00 000 000 12', false),
       ('0b73d612-f34a-41a1-9977-854eb139cc52', 1, 1, 'f45ef247-e76c-45b5-85ae-163ca4e65316',
        '661f25a7-b2f3-4765-9cbd-b54eb15c1830', '+48 00 000 000 21', true),
       ('c85ba1e3-23c0-4919-9f5e-830284b95664', 1, 1, 'f45ef247-e76c-45b5-85ae-163ca4e65316',
        'd25734b0-3b40-41a5-9e94-4de4698c840a', '+48 00 000 000 22', false),
       ('c21705e2-a9d4-4b07-80c1-fb5fc01a09b1', 1, 1, 'c9c138b1-d73b-4528-a628-dcc52d43435d',
        '661f25a7-b2f3-4765-9cbd-b54eb15c1830', '+48 00 000 000 31', true),
       ('9a8d02c4-07dd-4ee5-836f-18268ed3c1f4', 1, 1, 'c9c138b1-d73b-4528-a628-dcc52d43435d',
        'd25734b0-3b40-41a5-9e94-4de4698c840a', '+48 00 000 000 32', false),
       ('11be3528-dfcb-4174-a78a-74bbdf547c5d', 1, 1, '587c048e-060c-479c-94a1-8d65ae63b369',
